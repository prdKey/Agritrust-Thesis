		...
		"outputs": [
			{
				...
				"internalType": "struct AgriMarketplaceEscrow.LogisticsUpdate[]",
				"name": "",
				"type": "tuple[]"
			}
		],
		...
		"outputs": [
			{
				"components": [
					...
					{
						"internalType": "enum AgriMarketplaceEscrow.OrderStatus",
						"name": "status",
						"type": "uint8"
					}
				],
				"internalType": "struct AgriMarketplaceEscrow.Order[]",
				"name": "",
				"type": "tuple[]"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct AgriMarketplaceEscrow.Product[]",
				"name": "",
				"type": "tuple[]"
			}
		],
