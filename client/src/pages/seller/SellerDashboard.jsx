  ...
  return (
    <div className="min-h-screen rounded-lg bg-gray-100 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <MetricCard title={"Products"} value={102} icon={Package} color={"bg-blue-500"}/>
        <MetricCard title={"Sales"} value={2354} icon={Coins} color={"bg-green-500"}/>
        <MetricCard title={"Orders"} value={343} icon={ShoppingCart} color={"bg-purple-500"}/>
